...
from components.updater.DDQULearner import DDQULearner
...
class Runner:
    def __init__(self, config):
        ...
        # 2. 初始化 TensorBoard
        run_name = f"{config['env_name']}_DoubleDQN_{datetime.now().strftime('%Y%m%d-%H%M%S')}"
